...
def test_actuator_health(client: TestClient) -> None:
...
def test_actuator_health_subpaths_match_contract(client: TestClient) -> None:
...
def test_actuator_health_unauthenticated_ok(client: TestClient) -> None:
